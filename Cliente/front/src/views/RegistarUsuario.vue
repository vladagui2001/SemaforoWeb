        ...
        <div class="container mt-4">
          ...
          <div class="col">
            <h2>Añadir un Usuario</h2><br>
                ...
                <button  class="btn btn-outline-secondary">Crear Usuario</button>
                <router-link to="/listausuarios"  v-on:click="sumit" class="btn btn-success m-3">Cancelar</router-link>
